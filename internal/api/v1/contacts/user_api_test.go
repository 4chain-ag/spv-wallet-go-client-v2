...
import (
	...
	"github.com/bitcoin-sv/spv-wallet-go-client/internal/api/v1/contacts/testfixtures"
...
func TestUserAPI_Contacts(t *testing.T) {
	tests := map[string]struct {
		...
		"HTTP GET /api/v1/contacts response: 200": {
			expectedResponse: testfixtures.ExpectedContactsPageFromUserAPI(t),
			responder:        httpmock.NewJsonResponderOrPanic(http.StatusOK, httpmock.File("testfixtures/jsons/user_api/get_contacts_200.json")),
		},
...
func TestUserAPI_ContactWithPaymail(t *testing.T) {
	...
	tests := map[string]struct {
		...
		fmt.Sprintf("HTTP GET /api/v1/contacts/%s response: 200", paymail): {
			expectedResponse: testfixtures.ExpectedContactWithPaymailFromUserAPI(t),
			responder:        httpmock.NewJsonResponderOrPanic(http.StatusOK, httpmock.File("testfixtures/jsons/user_api/get_contact_paymail_200.json")),
		},
...
func TestUserAPI_UpsertContact(t *testing.T) {
	...
	tests := map[string]struct {
		...
		fmt.Sprintf("HTTP PUT /api/v1/contacts/%s response: 200", paymail): {
			expectedResponse: testfixtures.ExpectedUpsertContactFromUserAPI(t),
			responder:        httpmock.NewJsonResponderOrPanic(http.StatusOK, httpmock.File("testfixtures/jsons/user_api/put_contact_upsert_200.json")),
		},
...
func TestUserAPI_RemoveContact(t *testing.T) {
	paymail := "john.doe.test@john.doe.test.4chain.space"
	tests := map[string]struct {
		responder   httpmock.Responder
		expectedErr error
...
func TestUserAPI_ConfirmContact(t *testing.T) {
...
func TestUserAPI_UnconfirmContact(t *testing.T) {
	paymail := "john.doe.test@john.doe.test.4chain.space"
	tests := map[string]struct {
		responder   httpmock.Responder
		expectedErr error
