...
import (
	...
	"github.com/bitcoin-sv/spv-wallet-go-client/internal/api/v1/stats/testfixtures"
...
func TestAdminAPI_Stats(t *testing.T) {
	tests := map[string]struct {
		...
		"HTTP GET /v1/admin/stats response: 200": {
			expectedResponse: testfixtures.ExpectedStatsResponseFromAdminAPI(),
			responder:        httpmock.NewJsonResponderOrPanic(http.StatusOK, httpmock.File("testfixtures/jsons/get_stats_200.json")),
		},
