...
func (u *UserAPI) Contacts(ctx context.Context, opts ...queries.QueryOption[filter.ContactFilter]) (*queries.ContactsPage, error) {
	res, err := u.contactsAPI.Contacts(ctx, opts...)
	if err != nil {
...
// Returns an error if the request fails or the response cannot be decoded.
func (u *UserAPI) AccessKeys(ctx context.Context, opts ...queries.QueryOption[filter.AccessKeyFilter]) (*queries.AccessKeyPage, error) {
	res, err := u.accessKeyAPI.AccessKeys(ctx, opts...)
	if err != nil {
...
// Returns an error if the API request fails or the response cannot be decoded.
func (u *UserAPI) Paymails(ctx context.Context, opts ...queries.QueryOption[filter.PaymailFilter]) (*queries.PaymailAddressPage, error) {
