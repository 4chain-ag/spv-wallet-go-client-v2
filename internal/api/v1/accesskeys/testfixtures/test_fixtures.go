...
func ExpectedGenerateAccessKeyFromUserAPI(t *testing.T) *response.AccessKey {
...
func ExpectedAccessKeyFromUserAPI(t *testing.T) *response.AccessKey {
	return &response.AccessKey{
		Model: response.Model{
			Metadata: map[string]interface{}{
				"key": "value",
...
func ExpectedAccessKeyPageFromUserAPI(t *testing.T) *queries.AccessKeyPage {
...
func ExpectedAccessKeysPageFromAdminAPI(t *testing.T) *queries.AccessKeyPage {
	return &queries.AccessKeyPage{
		Content: []*response.AccessKey{
			{
				Model: response.Model{
