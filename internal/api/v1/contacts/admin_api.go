...
const (
	adminAPIRoute = "api/v1/admin/contacts"
	adminAPI      = "Admin Contacts AdminAPI"
)
...
func (a *AdminAPI) UpdateContact(ctx context.Context, cmd *commands.UpdateContact) (*response.Contact, error) {
