...
func TestUserAPI_SharedConfig_APIResponses(t *testing.T) {
	tests := map[string]struct {
		...
		"HTTP GET /api/v1/configs/shared response: 200": {
			...
			responder: httpmock.NewJsonResponderOrPanic(http.StatusOK, httpmock.File("testfixtures/response_200_status_code.json")),
		},
